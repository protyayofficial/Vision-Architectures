...
class ResNet34(nn.Module):
    """
    ResNet34 model, consisting of an initial convolutional block followed by 4 stages of residual blocks.
    ...
    def __init__(self, in_channels=3, num_classes=1000):
        ...
        self.stage1 = self._make_stage(in_channels=64, out_channels=64, blocks=3)
        self.stage2 = self._make_stage(in_channels=64, out_channels=128, blocks=4, stride=2)
        self.stage3 = self._make_stage(in_channels=128, out_channels=256, blocks=6, stride=2)
        self.stage4 = self._make_stage(in_channels=256, out_channels=512, blocks=3, stride=2)
    ...
    def forward(self, x):
        """
        Defines the forward pass for the ResNet34 model.
