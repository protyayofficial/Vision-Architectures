...
class ResidualAttentionNetwork56(nn.Module):
    """
    Residual Attention Network with 56 layers.
    ...
    def __init__(self, in_channels=3, num_classes=1000):
        ...
        self.attentionstage2 = AttentionStage2(in_channels=512, out_channels=512)

        self.residualunit3 = ResidualUnit(in_channels=512, out_channels=1024, stride=2)

        self.attentionstage3 = AttentionStage3(in_channels=1024, out_channels=1024)
    ...
    def forward(self, x):
        ...
        out = self.attentionstage2(out)
        out = self.residualunit3(out)
        out = self.attentionstage3(out)
...
if __name__ == "__main__":
    ...
    model = ResidualAttentionNetwork56().to('cuda')
