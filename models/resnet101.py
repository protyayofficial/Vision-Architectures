...
class ResNet101(nn.Module):
    """
    ResNet101 model, consisting of an initial convolutional block followed by 4 stages of residual blocks.
    ...
    def __init__(self, in_channels=3, num_classes=1000):
        ...
        self.stage3 = self._make_stage(in_channels=512, out_channels=1024, blocks=23, stride=2)
    ...
    def forward(self, x):
        """
        Defines the forward pass for the ResNet101 model.
