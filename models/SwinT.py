...
class SwinTransformerT(nn.Module):
    """
    ...
    Args:
        ...
        stage_repeats (list, optional): Number of alternating attention blocks for each of the four stages. 
                                        It should be a list of four integers. Default is [2, 2, 6, 2].

    """
    def __init__(self, in_channels=3, num_classes=1000, embed_dims=96, num_heads=32, window_size=7, stage_repeats=[2, 2, 6, 2]):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = SwinTransformerT().to('cuda')
