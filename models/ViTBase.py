...
class ViTBase(nn.Module):
    """
    Vision Transformer (ViT) Model: Implementation of the base ViT architecture.
    ...
    """
    def __init__(self, in_channels=3, num_classes=1000, num_layers=12, embed_dims=768, mlp_size=3072, num_heads=12, dropout_p=0.1, patch_size=16, img_size=224):
        super().__init__()
