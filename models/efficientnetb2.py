...
class EfficientNetB2(nn.Module):
    """
    EfficientNetB2 model with variable depth and width scaling.
    """
    def __init__(self, in_channels=3, phi=1, alpha=1.2, beta=1.1, num_classes=1000, dropout_rate=0.3):
        super().__init__()
