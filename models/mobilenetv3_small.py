...
class MobileNetV3_Small(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=1000):
        ...
        self.block1 = InvertedResidual(in_channels=16, exp_size=16, out_channels=16, kernel_size=3, stride=2, use_SE=True, activation='RE')

        self.block2 = InvertedResidual(in_channels=16, exp_size=72, out_channels=24, kernel_size=3, stride=2, use_SE=False, activation='RE')

        self.block3 = InvertedResidual(in_channels=24, exp_size=88, out_channels=24, kernel_size=3, stride=1, use_SE=False, activation='RE')

        self.block4 = InvertedResidual(in_channels=24, exp_size=96, out_channels=40, kernel_size=5, stride=2, use_SE=True, activation='RE')

        self.block5 = InvertedResidual(in_channels=40, exp_size=240, out_channels=40, kernel_size=5, stride=1, use_SE=True, activation='RE')

        self.block6 = InvertedResidual(in_channels=40, exp_size=240, out_channels=40, kernel_size=5, stride=1, use_SE=True, activation='RE')

        self.block7 = InvertedResidual(in_channels=40, exp_size=120, out_channels=48, kernel_size=5, stride=1, use_SE=True, activation='HS')

        self.block8 = InvertedResidual(in_channels=48, exp_size=144, out_channels=48, kernel_size=5, stride=1, use_SE=True, activation='HS')

        self.block9 = InvertedResidual(in_channels=48, exp_size=288, out_channels=96, kernel_size=5, stride=2, use_SE=True, activation='HS')

        self.block10 = InvertedResidual(in_channels=96, exp_size=576, out_channels=96, kernel_size=5, stride=1, use_SE=True, activation='HS')

        self.block11 = InvertedResidual(in_channels=96, exp_size=576, out_channels=96, kernel_size=5, stride=1, use_SE=True, activation='HS')


        # Final convolution block
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=96, out_channels=576, kernel_size=1, stride=1, padding=0, bias=False, groups=96),
    ...
    def forward(self, x):
        """
        Forward pass of the MobileNetV3 Small model.
