...
class DenseNet169(nn.Module):
    """
    Implementation of the DenseNet169 architecture.
    ...
    def __init__(self, in_channels=3, num_classes=1000, growth_rate=32, compression_factor=0.5):
        ...
        self.denseblock3 = DenseBlock(in_channels=input_features, num_layers=32, growth_rate=growth_rate)
    ...
    def forward(self, x):
        """
        Forward pass for the DenseNet169 model.
