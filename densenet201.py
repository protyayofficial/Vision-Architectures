...
class DenseNet201(nn.Module):
    """
    Implementation of the DenseNet201 architecture.
    ...
    def __init__(self, in_channels=3, num_classes=1000, growth_rate=32, compression_factor=0.5):
        ...
        self.denseblock3 = DenseBlock(in_channels=input_features, num_layers=48, growth_rate=growth_rate)
        ...
        self.denseblock4 = DenseBlock(in_channels=input_features, num_layers=32, growth_rate=growth_rate)
        input_features = input_features + growth_rate * 32
    ...
    def forward(self, x):
        """
        Forward pass for the DenseNet201 model.
